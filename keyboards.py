...
def user_menu(is_developer: bool):
    ...
    if is_developer:
        ...
        kb.button(text="⚡ Задание сейчас", callback_data="dev_task_now")
        kb.button(text="⏳ Задание +3 мин", callback_data="dev_task_3")
        ...
        kb.button(text="💬 Написать в группу", callback_data="dev_say_group")
    kb.adjust(2)
    return kb.as_markup()
